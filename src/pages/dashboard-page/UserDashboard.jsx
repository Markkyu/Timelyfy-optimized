...
export default function UserDashboard() {
  ...
  } = useAssignedColleges(currentUserId);
  ...
  return (
    <div className="space-y-6 p-6 h-full flex flex-col justify-center ">
      ...
      <div className="grid grid-cols-4 gap-4">
        <StatCard title="Subjects" count={0} icon={SchoolIcon} />
      ...
      <main className="flex-1 bg-white border-12 border-white rounded-2xl shadow-md">
        {colleges_loading ? ( // Data Loading
          ...
          <section className="flex flex-col items-center justify-center h-full">
            <EmptyContent
              emptyTitle={"No College Programs Assigned Yet"}
              emptyDesc={
                "Get started by requesting the master scheduler or admin to assign a course to you."
              }
              icon={SchoolIcon}
            />
          </section>
