export default function AboutPage() {
  return (
    <div className="h-full flex flex-col bg-gray-50 text-gray-800 font-sans">
      ...
      {/* Content */}
      <main className="flex items-center justify-center px-6 md:px-16 ">
        <div className="">
          {/* About Section */}
          <div className="max-w-2xl p-8 h-full">
            ...
            <p className="text-gray-700 leading-relaxed text-justify text-base md:text-lg">
              ...
              courses. With Timelyfy, the progress of every schedule creator is
              transparent and connected to one another, resulting in effortless
              conflict checking.
            </p>
          </div>
        </div>
      </main>
      <section className="bg-white py-8 px-6 md:px-16 text-center shadow-md">
        ...
        <div className="flex gap-6 justify-center">
          ...
          <div className="bg-white shadow-md rounded-xl p-6 border flex flex-col items-center">
            ...
            <p className="text-sm text-gray-600">API-Database and Algorithm</p>
          </div>
        </div>
      </section>

      <footer className="bg-maroon-900 text-black text-center py-4 mt-auto">
        <p className="text-sm">
